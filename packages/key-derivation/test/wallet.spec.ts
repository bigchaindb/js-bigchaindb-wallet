...
describe('BigChainWallet', () => {
  describe('fromMnemonic', () => {
    it('creates wallet from mnemonic with defaults', () => {
      ...
      expect(wallet.getDerivatedPublicKey('sign', { account: 0 }, 'base58')).toEqual(
        FROM_MNEMONIC_ENGLISH_PUBLIC_KEY_0,
      );
      expect(wallet.getDerivatedPrivateKey('sign', { account: 0 }, 'base58')).toEqual(
        FROM_MNEMONIC_ENGLISH_SECRET_KEY_0,
      );
    });
    ...
    it('creates wallet from mnemonic with specific language', () => {
      ...
      expect(wallet.getDerivatedPublicKey('sign', { account: 0 }, 'base58')).toEqual(expectedPublic);
      expect(wallet.getDerivatedPrivateKey('sign', { account: 0 }, 'base58')).toEqual(expectedPrivateKey);
    });
